#!/usr/bin/env python3
"""
Local test server to practice the Memory Acceleration exploit
Run this in one terminal, then run the exploit against localhost:1337
"""
...
# Example memories for testing
MEMORIES = [
    "You don't have to add the z3 solver to your firmware ever again. Now you can use it forever.",
    "The quantum computer lab is located in sector 7-G of the research facility.",
    "Your father's last project involved neural network integration with blockchain technology.",
    "The encryption key is hidden in the genesis block of the memory chain.",
    "HTB{f4k3_fl4g_f0r_t3st1ng_0nly!}"
]
...
if __name__ == '__main__':
    print("[*] Starting Memory Acceleration test server on localhost:1337")
